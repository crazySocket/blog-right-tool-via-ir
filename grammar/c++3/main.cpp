...
bool parse(Iterator & input_it, Iterator input_end, data::text & text)
{
...
bool parse(Iterator & input_it, Iterator input_end, data::value & value)
{
    cout << __PRETTY_FUNCTION__ << endl;
    return parse(input_it, input_end, dynamic_cast<data::text&>(value));
}

bool parse(Iterator & input_it, Iterator input_end, data::key & key)
{
    cout << __PRETTY_FUNCTION__ << endl;
    return parse(input_it, input_end, dynamic_cast<data::text&>(key));
}

bool parse(Iterator & input_it, Iterator input_end, data::line & line)
{
    cout << __PRETTY_FUNCTION__ << endl;
